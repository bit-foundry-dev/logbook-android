...
public class ForgotPasswordUseCase extends UseCase<Void, ForgotPasswordUseCase.Params> {

    private final AuthRepository repository;
    private final StringProvider strings;

    @Inject
    public ForgotPasswordUseCase(AuthRepository repository, StringProvider strings) {
